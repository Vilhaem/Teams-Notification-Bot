...
namespace NotificationBot.SpeechService
{
    public static class SpeechService
    {
        ...
        public static async Task<Guid> GenerateTextToSpeechAudioFile(string text, string token,Uri endPointUri, ILogger logger)
        {
            ...
            //using FileStream fileStream = new($@"C:\Users\a-liuwilliam\source\repos\WebApplicationForBot\wwwroot\{objectId}.wav", FileMode.Create, FileAccess.Write, FileShare.Write);
